...
var elmApp = __webpack_require__(1);
...
var author$project$CssModules$CssModule = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
...
var author$project$CssModules$class = F2(
	function (_n0, accessor) {
		var classes = _n0.b;
...
var author$project$CssModules$classList = F2(
	function (_n0, list) {
		var classes = _n0.b;
...
var author$project$CssModules$toString = F2(
	function (_n0, accessor) {
		var classes = _n0.b;
		return accessor(classes);
	});
var author$project$CssModules$css = F2(
	function (stylesheet, classes) {
		var cssModule = A2(author$project$CssModules$CssModule, stylesheet, classes);
		return {
			P: author$project$CssModules$class(cssModule),
			Q: author$project$CssModules$classList(cssModule),
			ak: author$project$CssModules$toString(cssModule)
		};
	});
var author$project$Nested$Styles$styles = A2(
	author$project$CssModules$css,
	'./Nested/Nested.css',
	{ax: 'nested'});
var elm$html$Html$div = _VirtualDom_node('div');
var elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var elm$html$Html$text = elm$virtual_dom$VirtualDom$text;
var author$project$Nested$Nested$view = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			author$project$Nested$Styles$styles.P(
			function ($) {
				return $.ax;
			})
		]),
	_List_fromArray(
		[
			elm$html$Html$text('This is a nested div')
		]));
var author$project$Styles$styles = A2(
	author$project$CssModules$css,
	'./Main.css',
	{aC: 'something', aD: 'somethingElse'});
var author$project$Main$view = function (_n0) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				author$project$Styles$styles.P(
				function ($) {
					return $.aC;
				})
			]),
		_List_fromArray(
			[
				elm$html$Html$text('this is a div'),
				author$project$Nested$Nested$view
			]));
};
